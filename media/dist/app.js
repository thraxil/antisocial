...
var _user$project$Models$Model = F4(
	function (a, b, c, d) {
		return {fetched: a, read: b, current: c, unread: d};
	});
var _user$project$Models$Entry = F7(
	function (a, b, c, d, e, f, g) {
		return {id: a, title: b, link: c, description: d, published: e, feed_title: f, read: g};
	});
...
var _user$project$Commands$entryDecoder = A4(
...
var _user$project$Commands$fetchEntriesUrl = '/api/elmentries/';
...
var _user$project$Entries_List$entryRow = function (entry) {
	return A2(
...
var _user$project$Entries_List$currentRow = function (maybeEntry) {
	var _p0 = maybeEntry;
	if (_p0.ctor === 'Just') {
		var _p1 = _p0._0;
		return A2(
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$href(_p1.link),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text(_p1.published),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						},
						{
							...
							_0: A2(
								...
								},
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text(_p1.feed_title),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('span10'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											_elm_lang$html$Html$span,
											{
												...
												_0: A2(
													_elm_lang$html$Html_Attributes$property,
													'innerHTML',
													_elm_lang$core$Json_Encode$string(_p1.description)),
												_1: {ctor: '[]'}
											},
											{ctor: '[]'}),
										_1: {ctor: '[]'}
...
var _user$project$Entries_List$list = function (entries) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$Entries_List$entryRow, entries));
};
var _user$project$Entries_List$view = function (entries) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$Entries_List$list(entries),
			_1: {ctor: '[]'}
		});
};
...
var _user$project$View$unreadCounter = function (response) {
	var _p0 = response;
	if (_p0.ctor === 'Success') {
		return A2(
			_elm_lang$html$Html$div,
			...
			},
			{
				...
				_0: _elm_lang$html$Html$text(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'unread: ',
						_elm_lang$core$Basics$toString(_p0._0.unread))),
				_1: {ctor: '[]'}
			});
	} else {
...
var _user$project$View$page = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$Entries_List$currentRow(model.current),
			_1: {
				ctor: '::',
				_0: _user$project$Entries_List$view(model.unread),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$View$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$View$unreadCounter(model.fetched),
				_1: {ctor: '[]'}
			}
		});
};
