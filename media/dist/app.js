...
var _user$project$Models$initialModel = {unread: 0, entries: _krisajenkins$remotedata$RemoteData$Loading, current: _elm_lang$core$Maybe$Nothing};
var _user$project$Models$Model = F3(
	function (a, b, c) {
		return {unread: a, entries: b, current: c};
	});
var _user$project$Models$Entry = F8(
	function (a, b, c, d, e, f, g, h) {
		return {id: a, title: b, link: c, description: d, published: e, feed_title: f, read: g, current: h};
	});
...
var _user$project$Commands$entriesDecoder = _elm_lang$core$Json_Decode$list(_user$project$Commands$entryDecoder);
		...
		return A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href(entry.link),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$View$unreadCounter = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: _elm_lang$html$Html$text(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'unread: ',
					_elm_lang$core$Basics$toString(model.unread))),
			_1: {ctor: '[]'}
		});
};
var _user$project$View$page = function (response) {
	var _p0 = response;
	switch (_p0.ctor) {
		case 'NotAsked':
		...
		case 'Success':
			return _user$project$Entries_List$view(_p0._0);
		default:
			return _elm_lang$html$Html$text(
...
var _user$project$View$view = function (model) {
	return A2(
		...
		{
			ctor: '::',
			_0: _user$project$View$page(model.entries),
			_1: {
				ctor: '::',
				_0: _user$project$View$unreadCounter(model),
				_1: {ctor: '[]'}
			}
		});
};
