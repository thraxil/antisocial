...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('main_feed', 'modified',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('main_feed', 'modified')
    ...
    models = {
        ...
        'main.feed': {
            ...
            'etag': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256'}),
            'guid': ('django.db.models.fields.CharField', [], {'max_length': '256', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_failed': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'last_fetched': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'modified': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '256'}),
